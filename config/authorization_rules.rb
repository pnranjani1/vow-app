authorization do
  ...
  role :client do
    has_permission_on [:authusers, :invitations, :bank_details, :memberships, :addresses], :to => [:index, :new, :show, :create, :edit, :update, :destroy, :activate_user, :de_activate_user, :change_role, :client_new, :client_create, :admin_edit, :admin_update, :user_profile_picture, :update_profile_picture, :force_password_change]
  ...
  role :user do
    has_permission_on [ :addresses, :invitations, :memberships, :bank_details,  :usercategories], :to =>[:index, :new, :create, :show, :edit, :update, :destroy, :change_role]
    ...
    has_permission_on [:bills], :to => [:new, :create, :show, :local_sales, :interstate_sales, :tally_import, :user_bill, :bill_reports, :generate_esugan, :local_sales_reports, :interstate_report, :interstate_sales_reports, :tally_import_reports, :bill_local_sales_reports, :bill_interstate_sales_reports, :bill_tally_import_reports, :pdf_format, :pdf_format_select, :tally_import_report, :tally_import_excel, :invoice_format, :invoice_format_update, :captcha_image, :edit, :update, :sub_user_bill]
    has_permission_on [:authusers], :to => [:force_password_change, :client_edit, :client_update, :change_role, :client_create, :client_new, :user_profile_picture, :update_profile_picture, :secondary_user, :secondary_user_create, :invoice_format_update, :activate_user, :de_activate_user, :update, :invoice_format]
    has_permission_on [:taxes], :to => [:new, :create, :edit, :update, :show, :index]
 ...
 #   has_permission_on [:main_categories], :to => [:index]
  ...
  role :secondary_user do
    ...
    has_permission_on [:authusers], :to => [:force_password_change, :invoice_format_update, :client_edit, :client_update, :update]

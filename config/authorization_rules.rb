authorization do
  ...
  role :user do
    ...
    has_permission_on [:authusers], :to => [:client_edit, :client_update, :change_role, :client_create, :client_new, :user_profile_picture, :secondary_user, :secondary_user_create, :invoice_format_update]

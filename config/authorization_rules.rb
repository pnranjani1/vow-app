authorization do
  ...
  role :user do
    ...
    has_permission_on [:products], :to => [:new, :create, :show, :edit, :update, :destroy, :product_user]
    has_permission_on [:customers], :to => [:new, :create, :show, :edit, :update, :destroy, :user_customer]
    has_permission_on [:bills], :to => [:new, :create, :show, :local_sales, :intersate_sales, :tally_import, :user_bill]

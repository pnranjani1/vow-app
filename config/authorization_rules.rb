authorization do
  ...
  role :user do
    ...
    has_permission_on [:bills], :to => [:new, :create, :show, :local_sales, :interstate_sales, :tally_import, :user_bill, :bill_reports, :generate_esugan, :local_sales_reports, :interstate_sales_reports, :tally_import_reports, :bill_local_sales_reports, :bill_interstate_sales_reports, :bill_tally_import_reports, :pdf_format, :pdf_format_select]
    has_permission_on [:authusers], :to => [:client_edit, :client_update, :change_role, :client_create, :client_new, :user_profile_picture, :secondary_user, :secondary_user_create]
 #   has_permission_on [:main_categories], :to => [:index]
  ...
  role :secondary_user do
    ...
    has_permission_on [:bills], :to => [:new, :create, :show, :user_bill, :generate_esugan,:pdf_format, :pdf_format_select]
  end
